package com.survey.system.backend.utils;
...
public class DtoConverter {
    ...
    public static CreateSurveyResponseNoAuth toCreateSurveyResponseNoAuth(Survey survey){
        return new CreateSurveyResponseNoAuth(survey.getPublicKey(), survey.getPrivateKey());
    }

    public static CreateSurveyResponse toCreateSurveyResponse(Survey survey){
        return new CreateSurveyResponse(survey.getPublicKey(), survey.getId());
    }
    ...
    public static QuestionDto toQuestionDto(Question entity) {
        ...
        return new QuestionDto(entity.getId(), entity.getContent(),entity.isMultiple(), entity.isRequired(), answers);
    }
